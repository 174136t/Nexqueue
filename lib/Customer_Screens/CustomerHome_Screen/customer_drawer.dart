...
class CustomerDrawerScreen extends StatefulWidget {
  @override
  _CustomerDrawerScreenState createState() => _CustomerDrawerScreenState();
}

class _CustomerDrawerScreenState extends State<CustomerDrawerScreen> {
  _onWillPop() {
          ...
          Row(
            children: [
               CircleAvatar(backgroundColor: Colors.white,
                          child: Image.asset('assets/images/boy.png',filterQuality: FilterQuality.high,),
                          ),
              SizedBox(width: 10,),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Lahiru Neranjan',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                  Text('Active now',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold))
                ],
              )
            ],
          ),
          ...
          Column(
            children: drawerItems.map((element) => Padding(
              ...
              child: GestureDetector(
                onTap: (){
                   element['title'] == 'Exit app' ? _onWillPop() : null;
                },
                              child: Row(
                  children: [
